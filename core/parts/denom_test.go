...
func TestHeirarchicalToIndexed(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:       "34_2345_1_2",
			expected:    "34_2345_135",
			expectError: false,
		},
		{
			name:        "depth 2 path 1_5",
			input:       "34_2345_1_5",
			expected:    "34_2345_534",
			expectError: false,
		},
		{
...
func TestIndexedToHierarchical(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "index 667 -> path 2",
			input:       "34_2345_667",
			expected:    "34_2345_2",
			expectError: false,
		},
		{
			name:        "index 2 -> path 1_1",
			input:       "34_2345_2",
			expected:    "34_2345_1_1",
			expectError: false,
		},
		{
			name:        "index 135 -> path 1_2",
			input:       "34_2345_135",
			expected:    "34_2345_1_2",
			expectError: false,
		},
		{
			name:        "index 534 -> path 1_5",
			input:       "34_2345_534",
			expected:    "34_2345_1_5",
			expectError: false,
		},
		{
			name:        "index 3 -> path 1_1_1",
			input:       "34_2345_3",
			expected:    "34_2345_1_1_1",
			expectError: false,
		},
		{
			name:        "index 69 -> path 1_1_2",
			input:       "34_2345_69",

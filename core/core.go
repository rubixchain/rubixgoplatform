...
type Core struct {
	...
	advisoryNodeMainnetURL string
	advisoryNodeTestnetURL string
}
...
func NewCore(cfg *config.Config, cfgFile string, encKey string, log logger.Logger, testNet bool, testNetKey string, am bool, defaultSetup bool) (*Core, error) {
	...
	c := &Core{
		...
		advisoryNodeMainnetURL: "https://mainnet-pool.universe.rubix.net",
		advisoryNodeTestnetURL: "https://testnet-pool.universe.rubix.net",

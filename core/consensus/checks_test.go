...
func TestValidateTransaction_FailsOnInvalidInfoFields(t *testing.T) {
	...
	_, err := ValidateTransaction(
		...
		func(string, string) (*models.Transactions, error) { return nil, nil },        // fetchGenesisTx
		func(string) (*models.ResolvedProperties, error) { return nil, nil },          // resolveProperties
		func(string, string) (*models.ResolvedProperties, error) { return nil, nil },  // resolvePropertiesByTokenID

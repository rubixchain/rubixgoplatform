...
const (
	...
	APIGetDIDAccess                     string = "/api/login-did"
	APICreateDID                        string = "/api/create-did"
	APIGetAllDID                        string = "/api/get-all-did"
	APIGetAllTokens                     string = "/api/get-all-tokens"
	APIAddQuorum                        string = "/api/add-quorum"
	APIGetAllQuorum                     string = "/api/get-all-quorum"
	APIRemoveAllQuorum                  string = "/api/remove-all-quorum"
	...
	APIAddNFTSale                       string = "/api/add-nft-sale"
	...
	APIGetPledgedTokenDetails           string = "/api/get-pledged-token-details"
	...
	APIGenerateFaucetTestToken          string = "/api/generate-faucet-test-token"

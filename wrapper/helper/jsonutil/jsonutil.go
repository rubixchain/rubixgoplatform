...
func EncodeJSONAndCompress(in interface{}, config *CompressionConfig) ([]byte, error) {
	if in == nil {
		return nil, fmt.Errorf("input for encoding is nil")
	}
	...
	return Compress(encodedBytes, config)
}
...
func DecodeJSON(data []byte, out interface{}) error {
	...
	if err != nil {
		return fmt.Errorf("failed to decompress JSON")
	}

...
const (
	...
	RunCmd                         string = "run"
	PingCmd                        string = "ping"
	AddBootStrapCmd                string = "add-bootstrap"
	RemoveBootStrapCmd             string = "remove-bootstrap"
	RemoveAllBootStrapCmd          string = "remove-all-bootstrap"
	GetAllBootStrapCmd             string = "get-all-bootstrap"
	CreateDIDCmd                   string = "create-did"
	GetAllDIDCmd                   string = "get-all-did"
	AddQuorumCmd                   string = "add-quorum"
	GetAllQuorumCmd                string = "get-all-quorum"
	RemoveAllQuorumCmd             string = "remove-all-quorum"
	SetupQuorumCmd                 string = "setup-quorum"
	GenerateTestRBTCmd             string = "generate-test-rbt"
	TransferRBTCmd                 string = "transfer-rbt"
	GetAccountInfoCmd              string = "get-account-info"
	SetupServiceCmd                string = "setup-service"
	DumpTokenChainCmd              string = "dump-tokenchain"
	DecodeTokenChainCmd            string = "decode-tokenchain"
	RegsiterDIDCmd                 string = "register-did"
	SetupDIDCmd                    string = "setup-did"
	ShutDownCmd                    string = "shutdown"
	MirgateNodeCmd                 string = "migrate-node"
	LockTokensCmd                  string = "lock-tokens"
	CreateDataTokenCmd             string = "create-datatoken"
	CommitDataTokenCmd             string = "commit-datatoken"
	SetupDBCmd                     string = "setup-db"
	GetTxnDetailsCmd               string = "get-txn-details"
	CreateNFTCmd                   string = "create-nft"
	GetAllNFTCmd                   string = "get-all-nft"
	UpdateConfig                   string = "update-config"
	GenerateSmartContractToken     string = "generate-sct"
	FetchSmartContract             string = "fetch-sct"
	PublishContractCmd             string = "publish-sct"
	SubscribeContractCmd           string = "subscribe-sct"
	DeploySmartContractCmd         string = "deploy-smartcontract"
	ExecuteSmartcontractCmd        string = "execute-smartcontract"
	DumpSmartContractTokenChainCmd string = "dump-smartcontract-tokenchain"
	GetTokenBlock                  string = "get-tokenblock"
	GetSmartContractData           string = "get-smartcontract-data"
	GetPeerID                      string = "get-peer-id"
	ReleaseAllLockedTokensCmd      string = "release-all-locked-tokens"
	CheckQuorumStatusCmd           string = "check-quorum-status"
	AddExplorerCmd                 string = "add-explorer"
	RemoveExplorerCmd              string = "remove-explorer"
	GetAllExplorerCmd              string = "get-all-explorer"
	AddPeerDetailsCmd              string = "add-peer-details"
	GetPledgedTokenDetailsCmd      string = "get-pledged-token-details"
	CheckPinnedState               string = "check-pinned-state"
	...
	PinTokenCmd                    string = "pin-token"
	RecoverTokensCmd               string = "recover-token"
	GenerateFaucetTestRBTCmd       string = "generate-faucet-rbt"
	FaucetTokenCheck               string = "faucet-token-check"
	ValidateTokenchainCmd          string = "validate-tokenchain"
	FaucetTokenChainValidate       string = "faucet-tokenchain-validate"
	...
	CreateDIDFromPubKeyCmd         string = "create-did-from-pubkey"
	AddUserAPIKeyCmd               string = "add-user-apikey"
	AddPeerDetailsFromExplorer     string = "exp-peerdetails"
